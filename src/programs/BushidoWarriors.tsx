import "../sass/pages/program-details-4.scss"
import Footer from "../components/footer"
interface BushidoWarriorsProps {

}
const BushidoWarriors: React.FC<BushidoWarriorsProps> = ({ }) => {
    return (
        <div>
            <section className="program-details program-details-4">
                <h2>Bushido Warriors</h2>
...
export default BushidoWarriors;